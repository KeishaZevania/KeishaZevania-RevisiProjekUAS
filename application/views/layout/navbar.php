    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="<?= base_url() ?>" class="logo">
                ...
                <span class="logo-lg"><b>Dapur Yanti Soegi</b></span>
            </a>
                ...
                <div class="navbar-custom-menu">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<?= base_url() ?>/assets/template/dist/img/muka.jpg" class="user-image" alt="User Image">
                            <span class="hidden-xs"><?= $this->acces->nama_login()->name; ?></span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="<?= base_url() ?>/assets/template/dist/img/muka.jpg" class="img-circle" alt="User Image">
                            </li>
                            <!-- Menu Footer-->
